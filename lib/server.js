...
var handlers = [
	...
	{ path: "/send", handler: function(channel, request, response) {
		...
		// make a really slow API call
		///////////////////////////////////
		
    var http = require('http'),
        delay = Math.floor(Math.random()*100) + 0,
        options = {
          host: (text === '!!!') ? 'slowbro.duostack.net' : 'twitter.com',
          port: 80,
          path: '/' + ((text === '!!!') ? delay : ''),
        };
